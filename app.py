...
def fetch_articles_by_issn_period(issn, from_date, until_date):
    ...
    with progress_container:
        st.info("📥 Начинается загрузка статей из баз данных **Crossref** и **OpenAlex**. Анализ может занять длительное время в случае большого числа анализируемых статей или цитирований. Для получения 'быстрой' статистики рекомендуетсы уменьшить период...")
